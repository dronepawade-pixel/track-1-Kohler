...
- 2026-09-20: Prompts Documentation artefact — docs/prompts-documentation.html (print CSS, brand tokens) → docs/PROMPTS_DOCUMENTATION.pdf (12 pages): architecture, P-01/P-02 verbatim prompts + engineered specs, guardrail matrix (rubbish + live injection probes), model-selection log (2.0-flash retirement, thinking-token cost), build ledger, eval matrix. Linked from README submission artefacts.
